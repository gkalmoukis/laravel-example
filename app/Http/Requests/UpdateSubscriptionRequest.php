...
/**
 * A change to a subscription. The same rules as creating one: an edit must not be able
 * to put a subscription into a state it could never have been created in.
 */
